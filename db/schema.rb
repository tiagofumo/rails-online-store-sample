...
ActiveRecord::Schema.define(version: 20160725202435) do
  ...
  add_index "category_relationships", ["child_id"], name: "index_category_relationships_on_child_id"
  add_index "category_relationships", ["parent_id"], name: "index_category_relationships_on_parent_id"
